...
**For macOS users**:
- Open the downloaded `.dmg` file, drag the Teampusle application into your Applications folder, and then open it from there.

**For Linux users**:
- Open your terminal, navigate to the downloaded file's location, and run the command:
  ```
  chmod +x Teampusle-Linux
  ./Teampusle-Linux
  ```
...
2. Create a new database named `teampusle`.
3. Configure your database connection settings in the application settings.

### Step 5: Run Teampusle
